...
#returns an array where the first column is the magnification, the second column is volume without seg map, the last column is volume with seg map
...
#mumax = 16
    ...
    def getmu(Mag):
        return muref*10**(0.4*(Mag-Mref)) #whats going on?
    ...
    return MVolArray #The middle column tells you how much volume is at that specific magnification not how much is that magnification and above (thankfully)
    #return PartialMVolArray, TotalSPVolArray
