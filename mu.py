...
#Takes as input a light curve (a list of magnitudes with the shock breakout trimmed) and a magnitude limit
...
def lightcurve(sn_type, redshift, fil='WFC3_IR_F160W'):
...
types_list = ['z15b', 'z15d', 'z15g', 'z25b', 'z25d', 'z25g', 'z40b', 'z40g']
redshift = 7
limit = 27
f = open('mu.txt', 'w')
mu_list = []
for x in types_list:
    l_c = lightcurve(x, redshift)
    mu = mag_factor(l_c, limit)
    mu_list.append(mu)
    f.write('For SN type {} at a redshift z={} the magnification needed is {}\n'.format(x, redshift, mu))
